...
public class HandleOtherAlarmAttribute {
	...
	public static final String _AXDCLEAROID =".1.3.6.1.4.1.193.14.1.1.3.0.3012";
	public static final String _AXD301EASGCP=".1.3.6.1.4.1.193.60.2.5";
	public static final String _AXD301EASMLG=".1.3.6.1.4.1.193.60.2.6";
	public static final String _AXD301EASMIG=".1.3.6.1.4.1.193.60.2.7";
	public static final String _AXD301IMA=".1.3.6.1.4.1.353.5.7.1.2";
	public static final String _AXD301PNNIMIB=".1.3.6.1.4.1.193.14.1.3.2";
	public static final String _AXD301EQMSWSMIB=".1.3.6.1.4.1.193.14.1.2.4";
	public static final String _AXD301EQMIFSWSMIB=".1.3.6.1.4.1.193.14.1.2.5";
				...
				try {
					...
					final Date octet28Date = HandleTimeTranslation
								.createAlarmDateAndTime(octet28DateTime,
										countDate);
						//TODO:Need to Check
						notif.setTime(octet28Date.toString());
						...
						LOGGER.info("--- Date from 11 octet input :"
								+ HandleTimeTranslation
										.createAlarmDateAndTime(octet11OID));
						//TODO:Need to Check
						notif.setTime(octet11Date.toString());
