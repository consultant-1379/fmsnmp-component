...
public class SnmpPcMaps {
	...
	public static String getProbableCause(String pcString) {
		System.out.println(pcMap.get(pcString));
		return pcMap.get(pcString);
	}
	public static String getnewNameProbableCause(String newPCString)
	{
